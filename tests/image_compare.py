...
def CompareImageFiles(path1: str, path2: str) -> bool:
    ...
    if perc_diff == 0:
        ...
        # Obtain the median reported geometric difference of the pixel blocks that are actually differing.
...
if __name__ == '__main__':
    if len(sys.argv) < 3:
        ...
        # Return 0 if images compared equivalent, or 1 if a difference was identified.
